...
#引き寄せできる軽いエンティティにヒット
execute at @s[tag=!ReCr_NoPull] positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[tag=!ReCr_Hook_Common,type=!player,dx=0,type=!#re_h.shot:cannot_hook,type=!#re_h.shot:heavy] positioned ~0.5 ~0.5 ~0.5 run function re_h.shot:entity/hook/hit_entity
