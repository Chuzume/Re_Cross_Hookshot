...
#アイテム動作
execute as @a[nbt={SelectedItem:{id:"minecraft:crossbow",tag:{ItemName:Re_Cross_Hookshot}}}] at @s run function re_h.shot:item/re_cross_hookshot/main
execute as @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:crossbow",tag:{ItemName:Re_Cross_Hookshot}}]},nbt=!{SelectedItem:{id:"minecraft:crossbow"}}] at @s run function re_h.shot:item/re_cross_hookshot/main

#アイテム動作
execute as @a[nbt={SelectedItem:{id:"minecraft:crossbow",tag:{ItemName:Re_Basic_Cross_Hookshot}}}] at @s run function re_h.shot:item/re_basic_cross_hookshot/main
execute as @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:crossbow",tag:{ItemName:Re_Basic_Cross_Hookshot}}]},nbt=!{SelectedItem:{id:"minecraft:crossbow"}}] at @s run function re_h.shot:item/re_basic_cross_hookshot/main
